...
use Cedu\Mongodb\Query\Builder;
use Cedu\Mongodb\Eloquent\Builder as MoloquentBuilder;

use Yajra\DataTables\QueryDataTable;
use Yajra\DataTables\Utilities\Helper;

class MongoQueryDataTable extends QueryDataTable
{
    /**
    ...
    /**
     * @param \Cedu\Mongodb\Query\Builder $builder
     */
