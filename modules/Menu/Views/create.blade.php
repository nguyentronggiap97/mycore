...
@section('description', 'Menu create')
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <p class="desc">@lang('menu::menu.create')</p>
                    </div>
                </div>
            </div>
            <div class="col-md-7">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active fade in" id="tab-info">
                <div class="tab-content">
                    ...
                    <form id="user-form" action="{{ route('menu.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 fvalue">
                                        <input class="form-control" type="text" name="name" placeholder="@lang('menu::menu.name')" value="" data-rule-minlength="3" data-rule-maxlength="250" required="1" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="name" class="col-md-2">@lang('menu::menu.link') *:</label>
                                    <div class="col-md-6 fvalue">
                                        <input class="form-control" type="text" name="link" placeholder="@lang('menu::menu.link')" value="" data-rule-minlength="3" data-rule-maxlength="250" required="1" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 fvalue">
                                        <select class="form-control" data-placeholder="{{ __('menu:menu.select_parent') }}" required name="pid">
                                            ...
                                            @foreach($menu as $value)
                                                <option {{ (old('parent') == $value['_id']) ? 'selected' : '' }} value="{{ $value['_id'] }}">{{ $value['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 fvalue">
                                        <input class="form-control" type="number" min="1" name="sort" value="{{ old('sort') ?? 1 }}" >
                                    </div>
                                </div>
                                <div class="form-group">
