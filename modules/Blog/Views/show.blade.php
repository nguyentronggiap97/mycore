...
@section('content')
    <div id="page-content" class="profile2">
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
            <li class=""><a href="{{ route('menu.index') }}" data-toggle="tooltip" data-placement="right" title="@lang('menu::menu.show_list')"><i class="ion ion-chevron-left"></i></a></li>
            ...
            @can('menu.create')
            <a href="{{ route('menu.create') }}" class="btn btn-success btn-tab-header btn-add-field pull-right"> @lang('menu::menu.create')</a>
            @end
        </ul>
