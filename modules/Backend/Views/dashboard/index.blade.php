...
<section class="content section-report">
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="inner">
                <h3>{{ rand(20, 150) }}<sup style="font-size: 20px">@lang('messages.backend.order')</sup></h3>
                <p>@lang('messages.backend.total_orders')</p>
            </div>
            <div class="icon">
                <i class="ion ion-bag"></i>
            </div>
            <a href="" class="small-box-footer">@Lang('messages.detail') <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            <!-- small box -->
            ...
            <div class="inner">
                <h3>{{ rand(100, 200) }}<sup style="font-size: 20px">m</sup></h3>
                <p>@lang('messages.backend.total_revenue_provisional')</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="inner">
                <h3>{{ rand(20, 75) }}<sup style="font-size: 20px">%</sup></h3>
                <p>@lang('messages.purchase_rate.purchase_rate')</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="inner">
                <h3>{{ rand(25, 50) }}<sup style="font-size: 20px">%</sup></h3>
                <p>Giảm giá</p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <div class="box box-info">
                ...
                <!-- <div class="box-footer clearfix"> -->
                    <!-- <a href="" class="btn btn-sm btn-info btn-flat pull-left">Xem thêm</a> -->
                    <!-- <a href="" class="btn btn-sm btn-default btn-flat pull-right">Xem thêm</a> -->
                <!-- </div> -->
